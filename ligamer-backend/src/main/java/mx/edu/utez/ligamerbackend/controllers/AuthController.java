...
public class AuthController {
    ...
    public ResponseEntity<UserDto> getUserByName(@org.springframework.web.bind.annotation.PathVariable String name) {
        return ResponseEntity.ok(userService.getUserDetailsByNombre(name));
    }
}